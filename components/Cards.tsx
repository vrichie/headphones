...
const Cards = () => {
  return (
    <section
      className="container flex items-start justify-between gap-8 md:flex-row flex-col py-20"
      id="faqs"
    >
      {Headphones.map((item, index) => (
        ...
        >
          ...
          <button
            data-aos="zoom-in"
            className="absolute top-4 right-4 rounded-full w-12 hover:scale-105 transition aspect-square bg-black hover:black-yellow-400"
          >
